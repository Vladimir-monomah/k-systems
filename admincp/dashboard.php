		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Панель администратора <small>Краткое описание вашего приложения</small>
                        </h1>
						<ol class="breadcrumb">
                ...
                <div class="row">
                        ...
                        <div class="panel panel-primary text-center no-boder red">
							...
							<i class="fa fa-user fa-5x" aria-hidden="true"></i>
                             ...
                             <div class="panel-right">
								<h3><?php echo $num; ?></h3>
                               <strong> Сегодняшние пользователи &nbsp;</strong>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder green">
                            ...
                            <div class="panel-right">
								<h3><?php echo $num1; ?></h3>
                               <strong> Сегодняшние заказы</strong>
...
?>
<h3 class="chart-title">Отчет о заказах за последние 7 дней</h3>
<head>  
