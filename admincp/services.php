...
<!--<div class="err-msg" id="err_id"><?php echo $msg;?></div>-->
			...
			<input type="hidden" id="hid" name="hid" value="<?php echo $services_id;?>">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 text-center" >
					<?php if(isset($_REQUEST['services_id'])) { ?>
					<button type="button" class="btn btn-primary" onclick="javascript:services_funct()">Обновить</button>
					<?php } else { ?>
					<button type="button"  class="btn btn-primary" onclick="javascript:services_funct()">Добавить</button>
					<?php } ?>
				</div>
