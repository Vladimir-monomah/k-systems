...
<!--<div class="err-msg" id="err_id"><?php echo $msg;?></div>-->
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 text-center" >
					...
					<button type="button" class="btn btn-primary" onclick="javascript:services_sub_funct('update')">Обновить</button>
					<?php } else { ?>
					<button type="button"  class="btn btn-primary" onclick="javascript:services_sub_funct('add')">Добавить</button>
					<?php } ?>
				</div>
					<div class="col-lg-3 col-md-3 col-sm-3"></div>
					</div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
											...
											<th>Название дполнительной услуги</th> 
											<th>Цена</th>
											<th>Обновить</th>
											<th>Удалить</th>	
                                        </tr>
