...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 30 2022 г., 18:39
...
(1, 'athi@gmail.com', 'athi@gmail.com', 'athi', 'lakshmi', '6987541236', '96265', '1', '1', '1', '2017-04-20', 'nationality', '              ', 'location', '', '111', '2017-04-07', '2021-02-28');
...
(9, 'Данил', 'sdvsdv', '5', '6', '2021-03-21', '11:00 AM', '            sdvdffvdffv', '111', '111', '8', 400, 'cash', 'completed', '-');
...
(8, 'Данил', 'afs@mai.ru', '202cb962ac59075b964b07152d234b70', '147', 'Бугульма', 'Ямашева 45', '423230', 1, '2021-03-21', '2021-03-21');
...
--
ALTER TABLE `sv_user_order`
  MODIFY `order_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT для таблицы `sv_user_profile`
--
ALTER TABLE `sv_user_profile`
  MODIFY `signup_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
