                ...
                <nav class="navbar navbar-inverse navbar-static-top marginBottom-0" role="navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse-1">
                        <ul class="nav navbar-nav pull-right">
                            <li><a class="nav__link" href="<?php echo $site_url; ?>/users/howitworks.php">Как это устроено</a></li>
                            ...
                            <?php
                             ...
                             <li><span class="link_to_another_page"><a class="nav__link nav__link--prominent" href="<?php echo $site_url; ?>/users/order.php">Разместите свой заказ</a></span></li>
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo $site_url; ?>/users/dashboard.php">Информация для заказа</a></li>
                                    <li><a href="<?php echo $site_url; ?>/users/order.php">Разместите свой заказ</a></li>
                                    <li><a href="<?php echo $site_url; ?>/users/edit-profile.php">Редактировать профиль</a></li>
                                    <li><a href="<?php echo $site_url; ?>/users/change_password.php">Изменить пароль</a></li>
                                    <li><a href="<?php echo $site_url; ?>/users/apply.php">Станьте поставщиком услуг</a></li>
                                    <li><a href="<?php echo $site_url; ?>/users/logout.php">Выход</a></li>
                                </ul>
                            </li>
                            <?php } ?>
                        </ul>
