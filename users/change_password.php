...
<body class="splash-index">
  ...
  <section class="teaser main-teaser bg-top">
    ...
    <h1 class="sub-title">Изменить пароль
    </h1>
    <div class="min-space">
    </div>
    <div class="min-space">
    ...
    <div class="container">
      ...
      <div class="col-lg-9 col-md-9 col-sm-9">
        <div class="user-login">
          <h1 class="user-login__heading">Изменить пароль</h1>
         <!-- <form class="form-large" action="javascript:change_pwd();" accept-charset="UTF-8" method="post">-->
			...
			<button type="submit" class="user-login__action" onclick="javascript:change_pwd()">Установить новый пароль</button>
